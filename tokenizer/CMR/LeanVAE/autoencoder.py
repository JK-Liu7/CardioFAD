...
from LeanVAE.vae import DiagonalGaussianDistribution
from LeanVAE.backbones import Encoder_Arch, Decoder_Arch, ISTA
from LeanVAE.patcher_utils import Patcher, UnPatcher
...
class LeanVAE(nn.Module):
    ...
    def forward(self, x, log_image=False):
        ...
        latent = rearrange(z_mean, 'b t h w d -> b d t h w')
        ...
        return x, x_recon, latent, x_dwt, x_dwt_rec, posterior
