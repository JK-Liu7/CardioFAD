...
class Encoder_Arch(nn.Module):
    ...
    def _build_linear_patch(self, in_channel = 1, out_channel_low = 128, out_channel_high = 384, pt = 2, ph = 4, pw = 4):
        patch_config = {
            'video_low': (pt, ph, pw),
            'video_high': (pt, ph, pw),
            'image_low': (1, ph, pw),
...
class Decoder_Arch(nn.Module):
    ...
    def _build_linear_unpatch(self, in_channel = 1, out_channel_low = 128, out_channel_high = 384, pt = 2, ph = 4, pw = 4):
        patch_config = {
            'video_low': (pt, ph, pw),
            'video_high': (pt, ph, pw),
            'image_low': (1, ph, pw),
